...
VERSION = __import__('dxlfiletransferclient').get_version()
RELEASE_NAME = "dxlfiletransferclient-python-dist-" + str(VERSION)
...
subprocess.check_call(["sphinx-apidoc",
                       ...
                       os.path.join(DIST_PY_FILE_LOCATION, "dxlfiletransferclient")])
...
print("\nRemoving dxlfiletransferclient.egg-info\n")
remove_tree(os.path.join(DIST_PY_FILE_LOCATION, "dxlfiletransferclient.egg-info"))
