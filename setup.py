...
with open(os.path.join(CWD, "dxlfiletransferclient", "_version.py")) as f:
...
class LintCommand(Command):
    ...
    def run(self):
        ...
        subprocess.check_call(["pylint", "dxlfiletransferclient", "tests"] +
                              glob.glob("*.py"))
...
setup(
    ...
    packages=[
        ...
        "dxlfiletransferclient._config",
        "dxlfiletransferclient._config.sample"],
    ...
    description="File Transfer DXL Python client",
